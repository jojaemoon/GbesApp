    ...
    public partial class StudentPartyGameInwon
    {
        ...
        private void DownLoadExcel()
        {
            ...
            if (memberPart == "교육지원청")
            {
                ...
                title = excelFileName + " 종목별 참가인원현황";
            }
            ...
            {
                var worksheet = package.Workbook.Worksheets.Add("종목별참가인원현황");
                ...
                FileUtil.SaveAs(JSRuntimeInjector, excelFileName + " 종목별 참가현황.xlsx", package.GetAsByteArray());
            }
        }

        private void GoToCityInwon()
        {
            NavigationManagerInjector.NavigateTo("/StudentCityInwon");
        }

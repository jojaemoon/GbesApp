...
{
    public partial class YearTrackCityInwonTotal_Print
    {
        [Parameter]
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            if (memberName.Contains("학교") || memberName.Contains("교육지원청"))
            {
                CalculateInwonCity();
            }
            else
        ...
        {
            await JSRuntimeInjector.InvokeVoidAsync("open", new object[] { $"YearTrackCityInwonTotal_Print/{memberID}", "_blank" });
        }

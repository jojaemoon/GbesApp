...
namespace GBES.Services
{
    public class AppState
    {
        ...
        public List<string> GetDetailsByMarathon(string sname)
        {
            ...
            if (sname == "초등부")
            {
                list = new List<string> { "제1구간 남", "제2구간 남초(4,5학년)", "제3구간 여", "제4구간 남", "제5구간 여", 
                        "제6구간 여초(4,5학년)", "제7구간 남", "후보1 남초(4,5학년)", "후보2 여초(4,5학년)", "후보3 남초(6학년)", "후보4 여초(6학년)" };

            }
            else if (sname == "중학부")
            {
                list = new List<string> { "제1구간 여", "제2구간 남", "제3구간 여", "제4구간 남", "제5구간 여", 
                        "제6구간 남", "후보1 남중(1,2학년)", "후보2 여중(1,2학년)", "후보3 남중(3학년)", "후보4 여중(3학년)" };
